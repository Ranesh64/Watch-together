      ...
      <header className="px-4 flex justify-between fixed top-0 left-0 right-0 z-30 bg-body-black">
        <div className="flex items-center">
          <div className="p-2 cursor-pointer" onClick={handleMenuToggle}>
            ...
            >
              <path
                d="M17.25 1.50002H0.75V0.583355H17.25V1.50002ZM17.25 6.08335H0.75V7.00002H17.25V6.08335ZM17.25 11.5834H0.75V12.5H17.25V11.5834Z"
                fill="white"
              />
            </svg>
          </div>
        ...
        <div className="flex items-center basis-3/4 grow-0 shrink justify-center">
          <input
            type="text"
            className="bg-inherit border border-[#474747] p-[9px] rounded-l-full w-1/2 ml-10 box-border pl-4 placeholder:text-neutral-500 focus:outline-none focus:border-blue-500"
            placeholder="Search"
            value={searchQuery}
          ...
          <button className="bg-zinc-800 p-3 rounded-full">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="18"
              height="18"
